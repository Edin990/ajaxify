...
class Hints { constructor(h) { let _ = this;
	_.hints = (typeof h === 'string' && h.length > 0) ? h.split(", ") : false; //hints are passed as a comma separated string 
	_.find = (t) => (!t || !_.hints) ? false : _.hints.some(h => t.iO(h)); //iterate through hints within passed text (t)
}}
